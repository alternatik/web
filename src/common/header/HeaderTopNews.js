                        ...
                        <div className="col-lg-12">
                            <div className="inner">
                                ...
                                <div className="right-button">
                                    <a className="btn-read-more" target="_blank" rel="noreferrer" href="https://themeforest.net/checkout/from_item/33571911?license=regular"><span>Purchase Now <FiArrowRight /></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
