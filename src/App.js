...
import Alternatik from "./pages/Alternatik";
        ...
        <Router>
            <PageScrollTop>
                <Switch>
                    ...
                    <Route path={`${process.env.PUBLIC_URL + "/web-yazilim"}`} exact component={WebYazilim}/>
                    ...
                    <Route path={`${process.env.PUBLIC_URL + "/alternatik"}`} exact component={Alternatik}/>
                    ...
                    <Route path={`${process.env.PUBLIC_URL + "/hizmetlerimiz"}`} exact component={Service}/>
                    ...
                    <Route path={`${process.env.PUBLIC_URL + "/takimimiz"}`} exact component={Team}/>
                    <Route path={`${process.env.PUBLIC_URL + "/referanslar"}`} exact component={Testimonial}/>
                    <Route path={`${process.env.PUBLIC_URL + "/kurumsal-kimlik"}`} exact component={Timeline}/>
                    <Route path={`${process.env.PUBLIC_URL + "/sik-sorulanlar"}`} exact component={RnAccordion}/>
                    <Route path={`${process.env.PUBLIC_URL + "/hiz-rekorlari"}`} exact component={Tab}/>
                    <Route path={`${process.env.PUBLIC_URL + "/fiyatlar"}`} exact component={Pricing}/>
                    ...
                    <Route path={`${process.env.PUBLIC_URL + "/yorumlar"}`} exact component={Video}/>
                    <Route path={`${process.env.PUBLIC_URL + "/galeri"}`} exact component={Gallery}/>
                    <Route path={`${process.env.PUBLIC_URL + "/iletisim"}`} exact component={Contact}/>
                    <Route path={`${process.env.PUBLIC_URL + "/is-cozumleri"}`} exact component={Brand}/>
                    <Route path={`${process.env.PUBLIC_URL + "/degerlerimiz"}`} exact component={AdvanceTab}/>
                    <Route path={`${process.env.PUBLIC_URL + "/advance-pricing"}`} exact component={AdvancePricing}/>
                    <Route path={`${process.env.PUBLIC_URL + "/biz-kimiz"}`} exact component={BizKimiz}/>

                    <Route path={`${process.env.PUBLIC_URL + "/error"}`} exact component={Error}/>
                    
                    <Route path={`${process.env.PUBLIC_URL + "/portfolio-uclu"}`} exact component={Portfolio}/>
