                                    ...
                                    <div className="rn-default-tab style-three">
                                        <div className="tab-button-panel">
                                            <TabList className="tab-button">
                                                ...
                                                <Tab>
                                                    <div className="rn-tab-button">
                                                        <button>İşletme</button>
                                                    </div>   
                                                </Tab>
                                                <Tab>
                                                    <div className="rn-tab-button">
                                                        <button>E-Ticaret</button>
                                                    </div>   
                                                </Tab>
                                            </TabList>
                                        </div>
                                                        ...
                                                        <div className="row align-items-center row--30">
                                                            <div className="col-lg-4">
                                                                <div className="section-title">
                                                                    <h4 className="title">SEO için bonus puan!</h4>
                                                                    <p>Google mobilde hızlı olan web sitelerine üst sıralarda daha fazla yer vermeye başladı.</p>
                                                                    <div className="read-more">
                                                                        <a className="btn-default btn-small" href="/blog">Okumaya devam et</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                            ...
                                                                            <div className="card-box card-style-1 text-left">
                                                                                <div className="inner">
                                                                                    ...
                                                                                    <div className="content">
                                                                                        ...
                                                                                        <Link className="btn-default btn-small" to="#service">Okumaya Devam Et</Link>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
