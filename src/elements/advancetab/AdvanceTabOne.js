                            ...
                            <TabList className="tab-button-list">
                                <Tab>
                                    <div className="tab-button">
                                        <h4 className="title">Misyonumuz</h4>
                                        <p className="description">Dijital deneyimi son kullanıcı ve kobiler için iyileştirerek işlerine odaklanmalarını sağlamak.</p>
                                    </div>   
                                </Tab>
                                <Tab>
                                    <div className="tab-button">
                                        <h4 className="title">Vizyonumuz.</h4>
                                        <p className="description">Teknoloji lideri, yenilikçi ve birinci sınıf BT Çözümlerinden biri olmak.</p>
                                    </div>   
                                </Tab>
                                <Tab>
                                    <div className="tab-button">
                                        <h4 className="title">Değerlerimiz</h4>
                                        <p className="description">Müşteri Memnuniyetine Bağlı, ödüllendirici sonuçlar üretmek.</p>
                                    </div>   
                                </Tab>
                            </TabList>
                        </div>
