...
const Social = () => {
    return (
        <>
            <SEO title="Social Share || Alternatik - Dijital Çözümler" />
            <Layout>
                <BreadcrumbOne 
                            ...
                            <div className="row mt--30">
                                <div className="col-lg-12">
                                    <ul className="social-icon social-default">
                                        <li><Link to="https://facebook.com/alternatikwebyazilim"><FiFacebook /></Link></li>
                                        <li><Link to="https://twitter.com/alternatikweb"><FiTwitter /></Link></li>
                                        <li><Link to="https://instagram.com/alternatikweb"><FiInstagram /></Link></li>
                                        <li><Link to="https://linkedin.com/company/alternatikweb"><FiLinkedin /></Link></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
