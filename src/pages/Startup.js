                                        ...
                                        <div className="col-lg-12">
                                            <div className="inner text-center">
                                                ...
                                                <div className="button-group mt--30">
                                                    <a className="btn-default btn-large round" target="_blank" rel="noreferrer" href="https://themeforest.net/checkout/from_item/33571911?license=regular">Get started now</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
